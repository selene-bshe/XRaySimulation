...
"""
Note from 2024-04-17
I have implemented the prepare_beam_optics function
before the implementation of the controller module.
However, I realized that the controller module requires 
a re-implemnetation of functions covered by the prepare_beam_optics module.
I think this is okay since re-inventing things is inevatible. 
I am keeping this old function however for multiple reasons. 

1. It is simpler to theoretical analysis.
2. It guides the implementation of the more complete simulation
3. It is a reference. 
...
def get_optics():
    ...
    TG_mirror_probe_list = [Crystal.TotalReflectionMirror(surface_point=np.array([0, 0, TG_mirror_probe_position[0]]),
                            ...
                            Crystal.CrystalBlock3D(
                                h=np.array([- np.pi * 2 / si111['d'], 0, 0], dtype=np.float64),
